...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    cmake_parse_arguments(ARG "INSTALL" "NAME;VERSION_CODE;PACKAGE_NAME;PACKAGE_SOURCES;KEYSTORE_PASSWORD;BUILDTOOLS_REVISION;API_LEVEL" "DEPENDS;KEYSTORE" ${ARGN})
    ...
    if (ARG_API_LEVEL)
        set(TARGET_LEVEL_OPTIONS --android-platform android-${ARG_API_LEVEL})
    ...
    add_custom_target(
        ...
        COMMAND ${QT_ANDROID_QT_ROOT}/bin/androiddeployqt --verbose --output ${CMAKE_CURRENT_BINARY_DIR} --input ${CMAKE_CURRENT_BINARY_DIR}/qtdeploy.json --gradle ${TARGET_LEVEL_OPTIONS} ${INSTALL_OPTIONS} ${SIGN_OPTIONS} --stacktrace
    )
